...
class EnvironmentRubricsImporter(PostgresDataImporter):
    ...
    def __init__(self, db_name='liege_environnement', table_name='tabrub1', key_column='rubrique_rubrique1', **kwargs):
        super(EnvironmentRubricsImporter, self).__init__(db_name, table_name, key_column, **kwargs)
